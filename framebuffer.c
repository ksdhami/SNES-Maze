    ...
    for (i = 0; i < numberOfRows; i++) {
        ...
        for (j = 0; j < numberOfColumns; j++) {
            if (i==0) { // row 1
                ...
                if (j==0 || j==2 || j==4 || j==10 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==2) { // row 3
                if (j==4 || j==6 || j==8 || j==12 || j==13 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==3) { // row 4
                if (j==0 || j==2 || j==3 || j==4 || j==6 || j==8 || j==9 || j==10 || j==11 || j==12 || j==13 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==4) { // row 5
                if (j==0 || j==3 || j==6 || j==13 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==5) { // row 6
                if (j==0 || j==1 || j==5 || j==6 || j==7 || j==8 || j==9 || j==11 || j==12 || j==13 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==6) { // row 7
                if (j==0 || j==3 || j==5 || j==9 || j==11 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==7) { // row 8
                if (j==0 || j==2 || j==3 || j==5 || j==7 || j==8 || j==9 || j==11 || j==13 || j==14 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==8) { // row 9
                if (j==0 || j==3 || j==5 || j==7 || j==9 || j==11 || j==13) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==9) { // row 10
                if (j==0 || j==1 || j==3 || j==7 || j==9 || j==11 || j==12 || j==13 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
            } else if(i==10) { // row 11
                if (j==0 || j==3 || j==5 || j==9 || j==15) {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color1);
                } else {
                    drawSquare(i * squareSize, j * squareSize, squareSize, color2);
                }
...
void displayFrameBuffer()
{
    ...
    drawCheckerboard(numberOfRows, numberOfColumns, squareSize, PURPLE, WHITE);
}
